...
public class TestGui 
{
	...
	private void initialize() 
	{
		...
		frmCodebuilder.setBounds(100, 100, 550, 300);
		...
		list.setBounds(258, 7, 180, 204);
		list.setVisible(false);
		frmCodebuilder.getContentPane().add(list);
		...
		btnGenerateCode.setBounds(205, 217, 117, 25);
		...
		btnAdd.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0)
			{
				...
				case OBJECT_TYPE.TYPE_TIMER:	if(textField.getText().equals(""))
												...
												{
														Objects.add(new Timer(textField.getText(),textField.getText()));
												}
												break;
				...
				if(isSucess)
					list.add((String)comboBox.getSelectedItem());
