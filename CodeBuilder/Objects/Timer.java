...
public class Timer extends Object
{
	 ...
	 */
	public Timer(String InterfaceName,String ComponentName)
	{
		super("Timer");
		...
		Component TimerComponent = new Component("TimerMilliC",ComponentName,true);
		AddComponent(TimerComponent);
		
		Interface TimerInterface = new Interface("Timer",InterfaceName);
		TimerInterface.SetPrecision("TMilli");
		AddInterface(TimerInterface);
